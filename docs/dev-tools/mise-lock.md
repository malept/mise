...
- ✅ **Full support** (version + checksum + size + URL): `aqua`, `http`, `github`, `gitlab`, `vfox` backend plugins with [`BackendPreInstall`](/backend-plugin-development#backendpreinstall-optional)
